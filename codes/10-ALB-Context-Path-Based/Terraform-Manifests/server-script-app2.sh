...
sudo echo '<!DOCTYPE html> <html> <body style="background-color:rgb(15, 232, 292);"> <h1>Welcome to Stack Simplify - APP-2</h1> <p>Terraform Demo</p> <p>Application Version: V1</p> </body></html>' | sudo tee /var/www/html/app2/index.html
